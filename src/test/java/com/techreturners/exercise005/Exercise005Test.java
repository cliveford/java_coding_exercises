...
public class Exercise005Test {
    ...
    @Test
    public void checkSentenceWithAllNumbersIsNotAPangram() {
        assertFalse(ex005.isPangram("0 456 78 33 213 00 998 8 7 6"));
    }

    @Test
    public void checkSentenceWithNumbersAndSymbolsIsNotAPangram() {
        assertFalse(ex005.isPangram("0 456 [] { } 78 .. 33 ,, 213 00 998 8 7 6"));
    }

    @Test
    public void checkSentenceWithNumbersAndSymbolsIsAPangram() {
        assertTrue(ex005.isPangram("the 1 quick brown } {fox . ,jumps over [] the 2 lazy dogs"));
    }
